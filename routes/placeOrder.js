									...
									let sql6="INSERT INTO payment VALUES('"+payment_id+"',"+body.cur_amt+",'"+body.pay_method+"',"+body.total_amt+")";
										...
										db.query(sql6,function(err,result5){
											...
											if(body.extra_id&&body.car_id){
												let sql3="INSERT INTO Orders VALUES('"+order_id+"','"+body.pay_date+"','"+body.dely_date+"','"+body.car_id+"','"+body.emp_id+"','"+result[0].cust_id+"','"+body.extra_id+"','"+payment_id+"')";
												...
												let sql3="INSERT INTO Orders VALUES('"+order_id+"','"+body.pay_date+"','"+body.dely_date+"','"+body.car_id+"','"+body.emp_id+"','"+result[0].cust_id+"',null,'"+payment_id+"')";
												db.query(sql3,function(err,result3){
													if(err) throw err;
													console.log(result3,"hii8");
												...
												let sql3="INSERT INTO Orders VALUES('"+order_id+"','"+body.pay_date+"','"+body.dely_date+"',null,'"+body.emp_id+"','"+result[0].cust_id+"','"+body.extra_id+"','"+payment_id+"')";
												db.query(sql3,function(err,result3){
													if(err) throw err;
													console.log(result3,"hii8");
															//res.render("new_order",{condition:true});
											...
											db.query(sql5,function(err,result5){
												...
												let sql6="INSERT INTO payment VALUES('"+payment_id+"',"+body.cur_amt+",'"+body.pay_method+"',"+body.total_amt+")";
													...
													db.query(sql6,function(err,result5){
														...
														if(body.extra_id&&body.car_id){
															let sql3="INSERT INTO Orders VALUES('"+order_id+"','"+body.pay_date+"','"+body.dely_date+"','"+body.car_id+"','"+body.emp_id+"','"+customer_id+"','"+body.extra_id+"','"+payment_id+"')";
														db.query(sql3,function(err,result3){
															if(err) throw err;
															console.log(result3,"hii8");
															...
															let sql3="INSERT INTO Orders VALUES('"+order_id+"','"+body.pay_date+"','"+body.dely_date+"','"+body.car_id+"','"+body.emp_id+"','"+customer_id+"',null,'"+payment_id+"')";
														db.query(sql3,function(err,result3){
															if(err) throw err;
															console.log(result3,"hii8");
															...
															let sql3="INSERT INTO Orders VALUES('"+order_id+"','"+body.pay_date+"','"+body.dely_date+"',null,'"+body.emp_id+"','"+customer_id+"','"+body.extra_id+"','"+payment_id+"')";
														db.query(sql3,function(err,result3){
															if(err) throw err;
															console.log(result3,"hii8");
